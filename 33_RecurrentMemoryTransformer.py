...
x = torch.randint(0, 256, (1, 567))

logits1, mem1, _ = model(x)        # (1, 567, 20000), (1, 128, 512), None
logits2, mem2, _ = model(x, mem1)  # (1, 567, 20000), (1, 128, 512), None
logits3, mem3, _ = model(x, mem2)  # (1, 567, 20000), (1, 128, 512), None
...
x = torch.randint(0, 256, (1, 678))

logits1, mem1, xl_mem1 = model(x)                               # (1, 678, 20000), (1, 128, 512), [(2, 1, 512, 512)]
logits2, mem2, xl_mem2 = model(x, mem1, xl_memories = xl_mem1)  # (1, 678, 20000), (1, 128, 512), [(2, 1, 512, 512)]
logits3, mem3, xl_mem3 = model(x, mem2, xl_memories = xl_mem2)  # (1, 678, 20000), (1, 128, 512), [(2, 1, 512, 512)]
